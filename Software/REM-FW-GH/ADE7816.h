...
// 0.5V peak = 353 mV rms ergeben 0x3FF6A6 mal  Rlast = 47 Ohm * Üebersetzungsverhältnis 2000
#define ScaleCurrentRawToAmpere (  0.353 / 0x3FF6A6  / 47  * 2000 )
// pro Halbwelle (= 1 LineCycle)     Gain und LineCycles werden in ScalePowerRawToWattWithGain() berücksichtigt
...
class ADE7816
{
    public:
		...
		bool hasNewValues();						// Fragt den Cip ab ob er neue Werte hat. Wird bei aufruf aus false zurückgesetzt!
		// Current
